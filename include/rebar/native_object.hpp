    ...
    public:
        ...
        [[nodiscard]] inline t_object& get_object() const noexcept {
            return reinterpret_cast<structured_native_object<t_object>*>(m_root_pointer)->m_data;
                      ...
                      inline void    overload_assignment                  (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_addition                    (environment& a_env, object& rhs);
                      inline void    overload_addition_assignment         (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_multiplication              (environment& a_env, object& rhs);
                      inline void    overload_multiplication_assignment   (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_division                    (environment& a_env, object& rhs);
                      inline void    overload_division_assignment         (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_subtraction                 (environment& a_env, object& rhs);
                      inline void    overload_subtraction_assignment      (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_equality                    (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_inverse_equality            (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_greater                     (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_lesser                      (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_greater_equality            (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_lesser_equality             (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_logical_or                  (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_logical_and                 (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_logical_not                 (environment& a_env);
        [[nodiscard]] inline object  overload_bitwise_or                  (environment& a_env, object& rhs);
                      inline void    overload_bitwise_or_assignment       (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_bitwise_xor                 (environment& a_env, object& rhs);
                      inline void    overload_bitwise_xor_assignment      (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_bitwise_and                 (environment& a_env, object& rhs);
                      inline void    overload_bitwise_and_assignment      (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_bitwise_not                 (environment& a_env);
        [[nodiscard]] inline object  overload_shift_right                 (environment& a_env, object& rhs);
                      inline void    overload_shift_right_assignment      (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_shift_left                  (environment& a_env, object& rhs);
                      inline void    overload_shift_left_assignment       (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_exponent                    (environment& a_env, object& rhs);
                      inline void    overload_exponent_assignment         (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_modulus                     (environment& a_env, object& rhs);
                      inline void    overload_modulus_assignment          (environment& a_env, object& rhs);
        ...
        [[nodiscard]] inline object& overload_index                       (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_select                      (environment& a_env, object& rhs);
        [[nodiscard]] inline object  overload_ranged_select               (environment& a_env, object& lhs, object& rhs);
