...
namespace rebar {
    ...
    inline void native_object::overload_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_addition(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_addition(&a_env, *this, rhs);
    }

    inline void native_object::overload_addition_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_addition_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_multiplication(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_multiplication(&a_env, *this, rhs);
    }

    inline void native_object::overload_multiplication_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_multiplication_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_division(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_division(&a_env, *this, rhs);
    }

    inline void native_object::overload_division_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_division_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_subtraction(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_subtraction(&a_env, *this, rhs);
    }

    inline void native_object::overload_subtraction_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_subtraction_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_equality(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_equality(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_inverse_equality(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_inverse_equality(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_greater(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_greater(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_lesser(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_lesser(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_greater_equality(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_greater_equality(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_lesser_equality(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_lesser_equality(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_logical_or(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_logical_or(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_logical_and(environment& a_env, object& rhs) {
    ...
    [[nodiscard]] inline object native_object::overload_bitwise_or(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_bitwise_or(&a_env, *this, rhs);
    }

    inline void native_object::overload_bitwise_or_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_bitwise_or_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_bitwise_xor(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_bitwise_xor(&a_env, *this, rhs);
    }

    inline void native_object::overload_bitwise_xor_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_bitwise_xor_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_bitwise_and(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_bitwise_and(&a_env, *this, rhs);
    }

    inline void native_object::overload_bitwise_and_assignment(environment& a_env, object& rhs) {
    ...
    [[nodiscard]] inline object native_object::overload_shift_right(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_shift_right(&a_env, *this, rhs);
    }

    inline void native_object::overload_shift_right_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_shift_right_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_shift_left(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_shift_left(&a_env, *this, rhs);
    }

    inline void native_object::overload_shift_left_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_shift_left_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_exponent(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_exponent(&a_env, *this, rhs);
    }

    inline void native_object::overload_exponent_assignment(environment& a_env, object& rhs) {
        this->get_virtual_table().overload_exponent_assignment(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_modulus(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_modulus(&a_env, *this, rhs);
    }

    inline void native_object::overload_modulus_assignment(environment& a_env, object& rhs) {
    ...
    [[nodiscard]] inline object& native_object::overload_index(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_operation_index(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_select(environment& a_env, object& rhs) {
        return this->get_virtual_table().overload_operation_select(&a_env, *this, rhs);
    }

    [[nodiscard]] inline object native_object::overload_ranged_select(environment& a_env, object& lhs, object& rhs) {
