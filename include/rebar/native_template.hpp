...
#define REBAR_NATIVE_FUNCTION(name) ::rebar::native_template_function_definition DEF_##name {m_environment, REBAR_STRINGIFY(name), class_name, *m_table, name}; \
                                    static REBAR_FUNCTION(name)

#define REBAR_NATIVE_CLASS(name, id) constexpr static std::string_view class_name = id; \
                                     name(environment& a_env) : native_template(a_env, id) {}
...
#define REBAR_OVERLOAD_ASSIGNMENT()                REBAR_OVERLOAD(assignment, void, const object& rhs)
#define REBAR_OVERLOAD_ADDITION()                  REBAR_OVERLOAD(addition, object, const object& rhs)
#define REBAR_OVERLOAD_ADDITION_ASSIGNMENT()       REBAR_OVERLOAD(addition_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_MULTIPLICATION()            REBAR_OVERLOAD(multiplication, object, const object& rhs)
#define REBAR_OVERLOAD_MULTIPLICATION_ASSIGNMENT() REBAR_OVERLOAD(multiplication_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_DIVISION()                  REBAR_OVERLOAD(division, object, const object& rhs)
#define REBAR_OVERLOAD_DIVISION_ASSIGNMENT()       REBAR_OVERLOAD(division_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_SUBTRACTION()               REBAR_OVERLOAD(subtraction, object, const object& rhs)
#define REBAR_OVERLOAD_SUBTRACTION_ASSIGNMENT()    REBAR_OVERLOAD(subtraction_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_EQUALITY()                  REBAR_OVERLOAD(equality, object, const object& rhs)
#define REBAR_OVERLOAD_INVERSE_EQUALITY()          REBAR_OVERLOAD(inverse_equality, object, const object& rhs)
#define REBAR_OVERLOAD_GREATER()                   REBAR_OVERLOAD(greater, object, const object& rhs)
#define REBAR_OVERLOAD_LESSER()                    REBAR_OVERLOAD(lesser, object, const object& rhs)
#define REBAR_OVERLOAD_GREATER_EQUALITY()          REBAR_OVERLOAD(greater_equality, object, const object& rhs)
#define REBAR_OVERLOAD_LESSER_EQUALITY()           REBAR_OVERLOAD(lesser_equality, object, const object& rhs)
#define REBAR_OVERLOAD_LOGICAL_OR()                REBAR_OVERLOAD(logical_or, object, const object& rhs)
#define REBAR_OVERLOAD_LOGICAL_AND()               REBAR_OVERLOAD(logical_and, object, const object& rhs)
#define REBAR_OVERLOAD_LOGICAL_NOT()               REBAR_OVERLOAD(logical_not, object)
#define REBAR_OVERLOAD_BITWISE_OR()                REBAR_OVERLOAD(bitwise_or, object, const object& rhs)
#define REBAR_OVERLOAD_BITWISE_OR_ASSIGNMENT()     REBAR_OVERLOAD(bitwise_or_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_BITWISE_XOR()               REBAR_OVERLOAD(bitwise_xor, object, const object& rhs)
#define REBAR_OVERLOAD_BITWISE_XOR_ASSIGNMENT()    REBAR_OVERLOAD(bitwise_xor_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_BITWISE_AND()               REBAR_OVERLOAD(bitwise_and, object, const object& rhs)
#define REBAR_OVERLOAD_BITWISE_AND_ASSIGNMENT()    REBAR_OVERLOAD(bitwise_and_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_BITWISE_NOT()               REBAR_OVERLOAD(bitwise_not, object)
#define REBAR_OVERLOAD_SHIFT_RIGHT()               REBAR_OVERLOAD(shift_right, object, const object& rhs)
#define REBAR_OVERLOAD_SHIFT_RIGHT_ASSIGNMENT()    REBAR_OVERLOAD(shift_right_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_SHIFT_LEFT()                REBAR_OVERLOAD(shift_left, object, const object& rhs)
#define REBAR_OVERLOAD_SHIFT_LEFT_ASSIGNMENT()     REBAR_OVERLOAD(shift_left_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_EXPONENT()                  REBAR_OVERLOAD(exponent, object, const object& rhs)
#define REBAR_OVERLOAD_EXPONENT_ASSIGNMENT()       REBAR_OVERLOAD(exponent_assignment, void, const object& rhs)
#define REBAR_OVERLOAD_MODULUS()                   REBAR_OVERLOAD(modulus, object, const object& rhs)
#define REBAR_OVERLOAD_MODULUS_ASSIGNMENT()        REBAR_OVERLOAD(modulus_assignment, void, const object& rhs)
...
#define REBAR_OVERLOAD_INDEX()                     REBAR_OVERLOAD(operation_index, object&, const object& rhs)
#define REBAR_OVERLOAD_SELECT()                    REBAR_OVERLOAD(operaion_select, object, const object& rhs)
#define REBAR_OVERLOAD_RANGED_SELECT()             REBAR_OVERLOAD(operaion_ranged_select, object, const object& rhs, const object& rhs1)
#define REBAR_OVERLOAD_CALL()                      REBAR_OVERLOAD_NO_PARAMS(operation_call, object)
#define REBAR_OVERLOAD_CONSTRUCT()                 REBAR_OVERLOAD_NO_PARAMS(new, object)
...
namespace rebar {
    ...
    struct native_template_function_definition {
        native_template_function_definition(environment& a_env, std::string_view a_name, std::string_view a_class, virtual_table& a_table, callable a_function);
    };
    ...
    public:
        ...
        using contained_type = t_internal_type;
    };
}
